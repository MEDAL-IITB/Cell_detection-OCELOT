...
for k in range(20,200):
    print(f"Epoch: {k}")
    path = glob.glob(f'/workspace/jay/DDP/Ocelot/cell_seg/deeplab_dice_ckpts_v2/{k}_*.pt')
    ...
    del model
    with open("/workspace/jay/DDP/Ocelot/ocelot23algo/evaluation/cellonlyseg_val.json", "w") as g:
